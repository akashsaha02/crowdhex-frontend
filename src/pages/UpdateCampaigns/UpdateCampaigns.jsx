...
const UpdateCampaigns = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col items-center justify-center py-10 px-4">
      ...
      <div className="w-full max-w-3xl bg-white dark:bg-gray-800 rounded shadow-lg p-4 sm:p-10">
        <form onSubmit={handleSubmit} className="space-y-6 dark:text-white">
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="block w-full mt-1 px-4 py-2 border rounded text-gray-700 dark:text-white focus:ring focus:ring-teal-300 dark:bg-gray-600 focus:outline-none"
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className="px-6 py-2 bg-teal-600 text-white rounded shadow-md hover:bg-teal-700 focus:ring focus:ring-teal-300 focus:outline-none"
            >
              Update Campaign
            </button>
          </div>
