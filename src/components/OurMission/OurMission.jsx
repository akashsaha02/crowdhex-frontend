        ...
        <section className="py-16 px-6 dark:bg-gray-900 bg-gray-50">
            ...
            <div className="mt-12 grid grid-cols-1 md:grid-cols-2 items-center justify-center space-y-8 md:space-y-0 lg:space-x-12">
                ...
                <div className="max-w-xl">
                    ...
                    <div className="mt-6">
                        <Link to={'/campaigns'} className="px-6 py-2 text-md font-semibold text-white bg-teal-600 hover:bg-teal-700 rounded shadow-lg transition-transform transform focus:ring-4 focus:ring-teal-400 focus:outline-none">
                            Get Involved
                        </Link>
                    </div>
                </div>
